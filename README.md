...
**mentionify.js** is a tiny JavaScript library that looks for all instances of @'s in the DOM's text nodes and injects an HTML `a` tag that links to that user's social media profile.
